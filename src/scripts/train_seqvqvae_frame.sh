...
TRAIN_DATA_PATH=$BASE_DIR/outputs/mind/train_mind_frame_histories_indices.csv
DEV_DATA_PATH=$BASE_DIR/outputs/mind/dev_mind_frame_histories_indices.csv
