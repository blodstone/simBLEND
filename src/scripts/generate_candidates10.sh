...
source ./secrets.sh
PREDICTION_PATH=$BASE_DIR/outputs/mind/seq_prediction_beam_10.txt
...
MILVUS_DATABASE_PATH=$BASE_DIR/outputs/mind/aspect_data_new2.db
COLLECTION_NAME="dev_mind_2019_11_14"
OUTPUT_PATH=$BASE_DIR/outputs/mind/seq_prediction_beam_10_cands.pickle
