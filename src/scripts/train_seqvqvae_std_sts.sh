...
TRAIN_DATA_PATH=$BASE_DIR/outputs/mind/train_mind_std_sts_histories_indices.csv
DEV_DATA_PATH=$BASE_DIR/outputs/mind/dev_mind_std_sts_histories_indices.csv
