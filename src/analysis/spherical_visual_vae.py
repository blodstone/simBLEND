...
embeddinq_dim = 256  # Dimensionality of the latent space
num_embeddings = 512  # Define the number of embeddings
vae_model = StandardVAE.from_checkpoint(
    checkpoint_path="/home/users1/hardy/hardy/project/vae/src/checkpoints/vae-epoch=01-val_loss=2.2854.ckpt",  # Replace with your checkpoint path
    base_model=model,
    latent_dim=embeddinq_dim,
...
def calculate(dataloader, name, ori_name):
    ...
    for batch in dataloader():
        ...
        with torch.no_grad():
            ...
            mu, logvar = vae_model.encode(ori_batch_embeddings)
            z = vae_model.reparameterize(mu, logvar)
            batch_embeddings = vae_model.decode(z)
...
calculate(mind.val_dataloader, "mds_vae_val_spherical_embeddings_visualization.html", "mds_ori_vae_val_spherical_embeddings_visualization.html")
calculate(mind.train_dataloader, "mds_vae_train_spherical_embeddings_visualization.html", "mds_ori_vae_val_spherical_embeddings_visualization.html")   
