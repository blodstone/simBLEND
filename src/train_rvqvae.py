...
if __name__ == "__main__":
    ...
    parser.add_argument("--decay", type=float, default=0.0, help="Weight decay for the EMA.")
    ...
    os.environ['CUDA_DEVICE_ORDER'] = 'PCI_BUS_ID'  # Ensure that the GPU order is consistent
